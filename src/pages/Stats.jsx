    ...
    return (
        <div className="space-y-12 pb-32">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                {/* Premium Level Gauge */}
                <div className="lg:col-span-2 glass-premium p-10 flex flex-col items-center justify-center relative overflow-hidden group">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-1 gap-4">
                    {[
                        ...
                        { icon: Zap, label: 'Current level', value: level, color: 'var(--color-gold)' },
                        { icon: Target, label: 'Success Rate', value: '92%', color: 'var(--color-gold)' },
                    ].map((stat, i) => (
                        <div key={i} className="glass-premium p-6 flex flex-col gap-3 group">
                            <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-white/5 text-gold group-hover:bg-gold group-hover:text-obsidian transition-all duration-500">
                                <stat.icon size={20} />
                            </div>
                            <div>
